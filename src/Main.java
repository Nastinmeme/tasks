public class Main {
    public static void main(String[] args) {
        ...
        Subtask newSub = new Subtask("Первый саб", "опаисание странного саба", 0, Status.NEW,
                newEpic.getId());
        manager.createSubtask(newSub);
        Subtask newSub2 = new Subtask("2 саб", "опаисание странного саба", 0, Status.NEW, newEpic.
                getId());
